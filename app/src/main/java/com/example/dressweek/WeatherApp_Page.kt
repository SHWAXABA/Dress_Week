...
class WeatherApp_Page : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_weather_app__page, container, false)
    }
    ...
    inner class WeatherAsyncTask : AsyncTask<Void, Void, String?>() {
